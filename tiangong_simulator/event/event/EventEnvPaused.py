...
from tiangong_simulator.event.EventType import EventType
from tiangong_simulator.registry.registry import register_event


@register_event('packet_factory.ENV_PAUSED')
class EventEnvFail(BaseEvent):
    event_type = EventType.ENV_PAUSED
