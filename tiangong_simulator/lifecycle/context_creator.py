...
@Date    ：2025/5/31 1:28 
'''
from tiangong_simulator.registry.registry import component_registry
from tiangong_simulator.lifecycle.initializer.env_initializer import initialize_env
from tiangong_simulator.lifecycle.initializer.agent_initializer import initialize_agent
