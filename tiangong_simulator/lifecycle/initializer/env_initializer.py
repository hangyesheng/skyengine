...
from tiangong_simulator.lifecycle.initializer.event_initializer import initialize_event_manager
from tiangong_simulator.registry.factory import create_component_by_id,get_component_class_by_id
