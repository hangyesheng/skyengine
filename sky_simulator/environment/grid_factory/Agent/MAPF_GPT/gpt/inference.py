...
from sky_simulator.environment.grid_factory.grid_factory_env.Utils.tokenizer import cost2go
from sky_simulator.environment.grid_factory.grid_factory_env.Utils.tokenizer.tokenizer import Encoder, InputParameters


class MAPFGPTInferenceConfig(AlgoBase, extra=Extra.forbid):
    name: Literal["MAPF_GPT"] = "MAPF_GPT"
    num_agents: int = 13
    ...
    repo_id: str = 'aandreychuk/MAPF_GPT'
